...
//ERUDA - offline loading from assets
var script = document.createElement('script'); script.src="file:///android_asset/scripts/eruda.js"; document.body.appendChild(script); script.onload=()=>{eruda.init();}
}
/**/
...
// Removed online script fetching - now loading from local assets
}
...
// Eruda loaded locally from assets if devMode is enabled
}
...
script2.src="file:///android_asset/scripts/ytpro.js";
...
// Showdown library removed - offline mode
// If needed, include showdown.min.js in assets/scripts/
...
// AdBlocker DISABLED - was causing "something went wrong" errors after 60 seconds
// The fetch interception was breaking YouTube's InnerTube API responses
// Will re-enable once core playback is stable
/*
(() => {
