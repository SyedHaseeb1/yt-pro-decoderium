...
public class MainActivity extends Activity {
    ...
    private void setDefaultOrientation() {
        float screenSize = getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_SIZE_MASK;
        boolean isTablet = screenSize >= Configuration.SCREENLAYOUT_SIZE_LARGE;
        setRequestedOrientation(isTablet ? ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE : ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT);
    }
    ...
    public void load(boolean dl) {
        ...
        String url = "https://www.youtube.com/?hl=en&gl=US";
